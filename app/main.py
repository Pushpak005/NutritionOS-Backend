...
from app.routers.restaurant_details import (
    router as restaurant_details_router
)


app = FastAPI(
    title="NutritionOS API"
)
...
app.include_router(restaurant_details_router)
...
def recommend(
    ...
    for dish in dishes:
        ...
        nutrition_score = calculate_score(
            dish
        )
